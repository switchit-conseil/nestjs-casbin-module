# Contributing to SWITCH IT CASBIN MODULE

**IMPORTANT NOTE**: The following document is quite the same as the one in 
[NestJS](https://github.com/nestjs/nest/blob/master/CONTRIBUTING.md), as we follow the same contribution
guidelines.

We would love for you to contribute to our module and help make it even better than it is
today! Here are the guidelines we would like you to follow:
...
Help us keep this module open and inclusive. Please read and follow our [Code of Conduct][coc]. -->
...
- For a **Major Feature**, first open an issue and outline your proposal so that it can be
  ...
  please prefix your proposal with `[discussion]`, for example "[discussion]: your feature idea".
...
In order to reproduce bugs we will systematically ask you to provide a minimal reproduction scenario using a 
repository or [Gist](https://gist.github.com/). Having a live, reproducible scenario gives us wealth of 
